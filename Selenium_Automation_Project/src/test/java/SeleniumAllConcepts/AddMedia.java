...
public class AddMedia {
	...
	Thread.sleep(2000);
		...
		System.out.println("URL of The Add Library Page is : " + URLofThePage);
	...
	public void titleOfSubmodule() {
	    ...
	    System.out.println("Title of Submodule is: " + actualTitle);
...
public void GetAttribute() {
	...
	System.out.println("Value of Attribure is : " + GetAttributeCopies.getAttribute("type") );
	JavascriptExecutor js = (JavascriptExecutor) driver;
